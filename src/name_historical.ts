...
export const historicalNames: NamingRule[] = [
  {
    ...
    text: `A popular street food found in the bustling markets where all cultures meet.`,
  ...
  },
  {
    ...
    text: `A specialty from Iroh's famous tea shop, blending techniques from his travels.`,
  ...
  },
  {
    ...
    text: `A dish originating from the former Fire Nation colonies, a true blend of two powerful cultures.`,
  ...
  },
  {
    ...
    text: `Inspired by the feasts held by Avatar Aang to promote harmony among the nations after the war.`,
  ...
  },
  {
    ...
    text: `A hearty meal created during the rebuilding of the Southern Water Tribe, using Earth Kingdom staples to supplement traditional polar ingredients.`,
  ...
  },
  {
    ...
    text: `A scholarly dish created by university chefs experimenting with cultural exchange.`,
  ...
  },
  {
    ...
    text: `A celebratory dish served during festivals honoring Avatar Kyoshi's legacy.`,
  ...
  },
  {
    ...
    text: `A refined dish shared among the secretive White Lotus Society members.`,
  ...
  },
  {
    ...
    text: `A dish that evolved along the bustling trade routes connecting the four nations.`,
  ...
  },
  {
    ...
    text: `A peaceful dish served during meditation sessions at the Air Temples.`,
  ...
  },
  {
    ...
    text: `A royal dish prepared for coronation ceremonies in the Fire Nation.`,
    weighting: { fusion: true, minNations: 2, themes: ['Ceremonial & Celebratory'] },
  },
  {
    id: 'water_tribe_ice_festival',
    title: (ctx) => `Water Tribe Ice Festival ${ctx.cookingStyle.dishSubtype}`,
    text: `A festive dish served during the annual ice festivals of the Water Tribes.`,
    weighting: { fusion: true, minNations: 2, themes: ['Ceremonial & Celebratory'] },
  },
  {
    id: 'earth_kingdom_harvest',
    title: (ctx) => `Earth Kingdom Harvest ${ctx.primaryIngredient.name}`,
    text: `A bountiful dish celebrating the rich harvests of the Earth Kingdom.`,
    weighting: { fusion: true, minNations: 2, themes: ['Humble & Meditative'] },
  },
  {
    id: 'southern_reconstruction',
    title: (ctx) => `Southern Reconstruction Stew`,
    text: `A hearty meal created during the reconstruction of the Southern Water Tribe, using Earth Kingdom staples to supplement traditional ingredients.`,
    weighting: { fusion: true, nations: ['water-tribe', 'earth-kingdom'], dishTypes: ['soup-stew'] },
  },
  {
    id: 'sun_warrior_pilgrimage',
    title: (ctx) => `Sun Warrior Pilgrim's Roast`,
    text: `A dish prepared by those who make the difficult journey to the ancient Sun Warrior civilization, combining Fire Nation discipline with ancient traditions.`,
  ...
  },
  {
    ...
    text: `A high-energy meal sold outside the Pro-Bending Arena in Republic City, combining quick Fire Nation cooking with hearty Earth Kingdom ingredients.`,
  ...
  },
  {
    ...
    text: `A refreshing dish created by members of the Order of the White Lotus at their oasis stronghold, using Water Tribe freezing techniques on desert fruits.`,
  ...
  },
  {
    ...
    text: `When the world opened up, Ember Island became a top tourist spot. Local vendors began mixing traditional Fire Nation sweets with exotic Air Nomad fruits.`,
