...
export const descriptiveNames: NamingRule[] = [
  {
    ...
    text: `A dish that captures the warm, golden light of sunset over the Fire Nation.`,
  ...
  },
  {
    ...
    text: `A dish inspired by the fog-shrouded peaks of the Earth Kingdom mountains.`,
  ...
  },
  {
    ...
    text: `A dish that reflects the pristine beauty of Water Tribe ice formations.`,
  ...
  },
  {
    ...
    text: `A dish that embodies the lightness and freedom of Air Nomad culture.`,
  ...
  },
  {
    ...
    text: `A dish that combines the rich green hues of Earth Kingdom jade with other elements.`,
  ...
  },
  {
    ...
    text: `A dish that marries the intensity of fire with the fluidity of water.`,
  ...
  },
  {
    ...
    text: `A dish that bridges the vast blue sky with the solid foundation of earth.`,
  ...
  },
  {
    ...
    text: `A dish that captures the warm, honeyed tones of autumn harvests.`,
  ...
  },
  {
    ...
    text: `A dish that reflects the mystical silver light of the moon over the Spirit World.`,
    weighting: { fusion: true, minNations: 2, themes: ['Ancient & Traditional'] },
  },
  {
    id: 'ruby_sunrise_special',
    title: (ctx) => `Ruby Sunrise Special ${ctx.primaryIngredient.name}`,
    text: `A dish that celebrates the brilliant red dawn of a new day across all nations.`,
  ...
  },
  {
    ...
    text: `A direct fusion of two distinct national styles.`,
  ...
  },
  {
    ...
    text: `Applying a traditional cooking method to ingredients from another land.`,
  ...
  },
  {
    ...
    text: `A dish that highlights a key ingredient prepared with foreign spices and techniques.`,
    weighting: { fusion: true, minNations: 2 },
  },
  {
    id: 'cross_cultural_dumpling',
    title: (ctx) => `Four-Elements Dumpling`,
    text: `A dumpling whose filling contains a signature ingredient from each of the four nations.`,
    weighting: { fusion: true, minNations: 4, dishTypes: ['snack'] },
  },
  {
    id: 'fusion_broth',
    title: (ctx) => `Republic City Broth Bowl`,
    text: `A complex broth combining the flavor bases of multiple nations.`,
  ...
  },
  {
    ...
    text: `An unusual but delicious pairing of ingredients from different corners of the world.`,
    weighting: { fusion: true, minNations: 2 },
  },
]; 