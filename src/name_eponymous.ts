...
export const eponymousNames: NamingRule[] = [
  {
    ...
    text: `A simple, vegetarian meal designed by the guru to open the body's chakras.`,
  ...
  },
  {
    ...
    text: `A compact, high-energy meal designed for the defenders of Kyoshi Island.`,
    weighting: { fusion: false, nations: ['earth-kingdom'], dishTypes: ['snack'] },
  },
  {
    id: 'name_avatar_roku',
    title: (ctx) => `Roku's Regret`,
    text: `A Fire Nation dish prepared with cooling Water Tribe ingredients, a somber reflection on past mistakes.`,
  ...
  },
  {
    ...
    text: `A simple cabbage stew. Surprisingly delicious, yet carries an inexplicable aura of sadness and misfortune.`,
    weighting: { fusion: false, nations: ['earth-kingdom'], ingredients: ['Cabbage'] },
  },
  {
    id: 'name_admiral_zhao',
    title: (ctx) => `Zhao's Conquest Feast`,
    text: `An arrogant, overly-spiced dish, combining the finest ingredients of two nations, meant to be served after a successful invasion.`,
  ...
  },
  {
    ...
    text: `A dish that combines seemingly incompatible ingredients in a way that somehow works perfectly, just like the mad genius of Omashu's king.`,
    weighting: { fusion: true, minNations: 2, themes: ['Invigorating & Playful'] },
  },
  {
    id: 'name_jet_freedom_fighter',
    title: (ctx) => `Jet's Forest Stew`,
    text: `A hearty stew made with ingredients foraged from the forest, representing the resourcefulness and determination of the Freedom Fighters.`,
  ...
  },
  {
    ...
    text: `A dish that requires exact timing and perfect technique to prepare, reflecting the princess's obsession with perfection and control.`,
  ...
  },
  {
    ...
    text: `A simple but profound dish that teaches patience and balance, much like the wisdom of the Dragon of the West.`,
    weighting: { fusion: false, nations: ['fire-nation'], themes: ['Humble & Meditative'] },
  },
  {
    id: 'name_sokka_warrior',
    title: (ctx) => `Sokka's Strategy`,
    text: `A dish that combines practical nutrition with clever preparation techniques, reflecting the Water Tribe warrior's tactical mind.`,
