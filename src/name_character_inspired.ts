...
export const characterInspiredNames: NamingRule[] = [
  {
    ...
    description: `A dish of conflicting flavors that ultimately find harmony, much like the Fire Lord's journey.`,
  ...
  },
  {
    ...
    description: `A comforting meal combining the restorative herbs of one culture with the nourishing bases of another.`,
  ...
  },
  {
    ...
    description: `A highly practical, if unconventional, combination of whatever could be found and cooked quickly. For the strategist on the go!`,
  ...
  },
  {
    ...
    description: `A no-frills dish that combines solid, dependable ingredients. It might not look fancy, but it's got substance.`,
  ...
  },
  {
    ...
    description: `A creative dish that respects Air Nomad vegetarian principles while incorporating bold flavors from other cultures.`,
  ...
  },
  {
    ...
    description: `A dish created in Iroh's tea house, combining traditional comfort food with exotic Fire Nation techniques.`,
  ...
  },
  {
    ...
    description: `A dish designed to provide the perfect balance of nutrition and energy for intensive Kyoshi Warrior training sessions.`,
  ...
  },
  {
    ...
    description: `A dish representing the attempt to create the ultimate fusion cuisine, combining the most prestigious elements of multiple nations.`,
  ...
  },
  {
    ...
    description: `A sophisticated dish that appears simple but contains hidden complexity, much like the character herself.`,
  ...
  },
  {
    ...
    description: `A bright, energetic dish that combines unexpected ingredients in a way that somehow just works.`,
  ...
  },
  {
    ...
    description: `A hearty, practical meal that could be prepared quickly in the wilderness, combining Earth Kingdom staples with whatever could be foraged.`,
    weighting: { fusion: true, nations: ['earth-kingdom'], minNations: 2, themes: ['Invigorating & Playful'] },
  },
  {
    id: 'long_feng_conspiracy',
    title: (ctx) => `Long Feng's Secret ${ctx.primaryIngredient.name}`,
    description: `A dish that appears to be one thing but contains hidden elements from other cultures, much like the Dai Li's secretive nature.`,
